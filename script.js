(function(){
  ...
  function setPhase(i){ phaseDts.forEach((d,j)=>d.classList.toggle('active',j===i)); if(phLabel) phLabel.textContent=phTexts[i]; }
...
if (priceEl) {
  ...
  const PRICING = {
    monthly:   { price: 3000, billed: '', savings: '' },
    quarterly: { price: 2550, billed: 'Facturado cada 3 meses', savings: 'Ahorra 15%' },
    yearly:    { price: 2100, billed: 'Facturado anualmente',   savings: 'Ahorra 30%' }
  };
